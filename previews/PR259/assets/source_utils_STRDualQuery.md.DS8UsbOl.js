import{_ as a,c as n,o as i,az as e}from"./chunks/framework.mcBEtuSi.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"source/utils/STRDualQuery.md","filePath":"source/utils/STRDualQuery.md","lastUpdated":null}'),p={name:"source/utils/STRDualQuery.md"};function l(t,s,h,r,k,d){return i(),n("div",null,s[0]||(s[0]=[e(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&quot;&quot;</span></span>
